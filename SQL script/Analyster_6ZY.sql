...
'D:\\Dropbox\\ELLE Prog 2015\\Analyster\\Original upload files\\Assignment Log 2015 Spring Assignments 18ZY.csv'
...
LOAD DATA LOCAL INFILE
'D:\\Dropbox\\ELLE Prog 2015\\Analyster\\Original upload files\\Assignment Log 2015 Spring Reports 17ZY.csv'
INTO TABLE Reports
FIELDS OPTIONALLY ENCLOSED BY '"' 
TERMINATED BY ','
LINES TERMINATED BY '\n'
